...
/* harmony import */ var recharts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! recharts */ "./node_modules/recharts/es6/cartesian/Brush.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tokenTxData.result.forEach((tx) => {
                priceData.unshift({
                    ...
                    $: parseFloat(((parseInt(tx.value) / Math.pow(10, parseInt(tx.tokenDecimal))) *
                        tokenPrice).toPrecision(3)),
                    hash: tx.hash,
                });
            });
...
const PriceGraphField = ({ coinId, quote }) => {
    ...
    return (chartData && (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { id: "price-graph-field" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { id: "price-graph-field-subtitle" },
            "Price past",
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_react-dom_index_js","vendors-node_modules_mui_icons-material_CompareArrows_js-node_modules_mui_icons-material_What-0438ea"], () => (__webpack_require__("./src/popup/popup.tsx")))
